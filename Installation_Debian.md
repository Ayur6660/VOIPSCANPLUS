This guide covers manual installation of the VOIPSCANPLUS VoIP billing software on Debian 11.
...
Copy and configure files
    ...
    sed -i "s/VOIPSCANPLUSFSIPADDRESS/${SERVER_IP}/" /etc/kamailio/dispatcher.list

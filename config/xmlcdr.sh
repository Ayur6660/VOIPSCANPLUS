#!/bin/bash
CONFIG_FILE=/home/VOIPSCANPLUS/etc/freeswitch/autoload_configs/xml_cdr.conf.xml
...
LOG=/home/VOIPSCANPLUS/var/log/freeswitch/freeswitch.log.*
rm -f $LOG

CDRDIR=$(get_param err-log-dir)
CDRDIR="/home/VOIPSCANPLUS/var/log/freeswitch/xml_cdr/"
